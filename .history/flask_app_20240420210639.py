...
# Simulando os dados
dados = [
    [1, "Promotor1", "Cliente1", "Endereco1", "EAN1", "Descricao1", "2022-12-31", 10],
    [2, "Promotor2", "Cliente2", "Endereco2", "EAN2", "Descricao2", "2022-11-30", 5]
]

# Chamando a função para formatar os dados
formatted_data = formatar_dados(dados)
