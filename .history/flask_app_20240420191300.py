...
novo_dado nomePromotor = dados["nomePromotor"] 
nomeCliente = dados["nomeCliente"] enderecoCliente = dados["enderecoCliente"] ean = dados["ean"] descricaoProduto = dados["descricaoProduto"] dataVencimento = dados["dataVencimento"] quantidadeProdutos = dados["quantidadeProdutos"]
