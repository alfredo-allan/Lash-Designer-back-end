...
def save_dados():
    ...
    nomePromotor = novo_dado['nomePromotor']
    nomeCliente = novo_dado['nomeCliente']
    enderecoCliente = novo_dado['enderecoCliente']
    ean = novo_dado['ean']
    descricaoProduto = novo_dado['descricaoProduto']
    dataVencimento = novo_dado['dataVencimento']
    quantidadeProdutos = novo_dado['quantidadeProdutos']
