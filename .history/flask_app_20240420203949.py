...
def save_dados(): 
    ...
    dados = novo_dado 
    nomePromotor = dados["nomeCliente"] 
    nomeCliente = dados["enderecoCliente"] 
    enderecoCliente = dados["ean"] 
    ean = dados["descricaoProduto"] 
    descricaoProduto = dados["dataVencimento"] 
    dataVencimento = dados["quantidadeProdutos"] 
