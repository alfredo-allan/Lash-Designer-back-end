...
def get_dados():
    ...
    formatted_data = []
    for item in dados:
        formatted_item = { "nomePromotor": item[1],
                           "nomeCliente": item[2], "enderecoCliente": item[3], "ean": item[4], "descricaoProduto": item[5], "dataVencimento": item[6], "quantidadeProdutos": str(item[7]) # Convertendo a quantidade para string }
        }
