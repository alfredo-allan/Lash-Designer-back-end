...
enderecoCliente = dados["enderecoCliente"] ean = dados["ean"] descricaoProduto = dados["descricaoProduto"] dataVencimento = dados["dataVencimento"] quantidadeProdutos = dados["quantidadeProdutos"]
