...
def save_dados(): novo_dado = request.json dados = 
novo_dado nomePromotor = dados["nomePromotor"] nomeCliente = dados["nomeCliente"] enderecoCliente = dados["enderecoCliente"] ean = dados["ean"] descricaoProduto = dados["descricaoProduto"] dataVencimento = dados["dataVencimento"] quantidadeProdutos = dados["quantidadeProdutos"]
