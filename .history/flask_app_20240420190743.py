...
@app.route('/salvar-dados', methods=['POST']) def save_dados(): novo_dado = request.json dados = novo_dado[0] nomePromotor = dados[1] nomeCliente = dados[2] enderecoCliente = dados[3] ean = dados[4] descricaoProduto = dados[5] dataVencimento = dados[6] quantidadeProdutos = dados[7]
